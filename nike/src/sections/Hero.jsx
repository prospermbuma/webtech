...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justiy-center items-start w-full max-xl:padding-x pt-28">
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stat) => (
            <div key={stat.label}>
              ...
              <p className="leading-7 font-montserrat text-slate-gray">{stat.label}
              </p>
            </div>
          ))}
        </div>
